...
function DescuentoCliente() {
  ...
  return (
    <div>
      <h3 className="text-xl font-semibold mb-4">Importar archivo XLSX - Descuento por Cliente</h3>
      ...
      <div className="flex space-x-4 mb-6">
        ...
        <Button variant="warning">Subir a Producción</Button>
      </div>
      ...
      <div className="grid grid-cols-1">
        <div className="col-span-1">
          <ImportForm 
            ...
            title="Importar archivo XLSX - Descuento por Cliente" 
          />
                  ...
                  {data.length > 0 ? (
                    data.map((item, index) => (
                      <tr key={index}>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{item.descuento}</td>
...
export default DescuentoCliente; 