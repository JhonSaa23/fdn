          ...
          <div className="grid grid-cols-4 md:grid-cols-4 gap-3 mb-3">
            ...
            />
              ...
              <div className="text-xs text-gray-500">
                {bonificacionesFiltradas.length} de {todasLasBonificaciones.length} resultados
              </div>
            </div>
        </div>
              ...
              <div className="overflow-x-auto rounded-lg border border-gray-200">
                <table className="min-w-full divide-y divide-gray-200 text-xs">
                  <thead className="bg-gray-50">
                    <tr>
                      <th className="px-2 py-2 text-left text-xs  text-gray-600 uppercase tracking-wider">
                        Cod
                      </th>
                      <th className="px-2 py-2 text-left text-xs  text-gray-600 uppercase tracking-wider w-24">
                        Nom
                      </th>
                      <th className="px-2 py-2 text-left text-xs  text-gray-600 uppercase tracking-wider">
                        Fact
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {bonificacionesFiltradas.map((bonificacion, index) => (
                      <tr key={index} className="hover:bg-blue-50 transition-colors duration-150">
                        ...
                        <td className="px-2 py-2 whitespace-nowrap text-xs text-gray-700">
                          <span className={`inline-flex items-center px-1.5 py-0.5 rounded-full text-xs font-medium ${
                            bonificacion.StockBonificacion > 0 
                              ? 'bg-green-100 text-green-800' 
                              : 'bg-red-100 text-red-800'
                          }`}>
